...
export const WRAPPED_NATIVE_ADDRESS: { [chainId in ChainId]: string } = {
...
export const EXCHANGE_ADDRESSES: { [chainId in ChainId]: string } = {
  [ChainId.MAINNET]: '0x61935cbdd02287b511119ddb11aeb42f1593b7ef',
  [ChainId.ROPSTEN]: '0x5d8c9ba74607d2cbc4176882a42d4ace891c1c00',
  [ChainId.RINKEBY]: '0xf8becacec90bfc361c0a2c720839e08405a72f6d',
  [ChainId.KOVAN]: '0xf1ec7d0ba42f15fb5c9e3adbe86431973e44764c',
  [ChainId.BSC]: NULL_ADDRESS,
  [ChainId.MATIC]: NULL_ADDRESS,
  [ChainId.MATIC_MUMBAI]: NULL_ADDRESS,
  [ChainId.AVALANCHE]: NULL_ADDRESS,
  [ChainId.FANTOM]: NULL_ADDRESS,
  [ChainId.CELO]: NULL_ADDRESS,
  [ChainId.OPTIMISM]: NULL_ADDRESS,
};

export const TOKENS: { [chainId in ChainId]: { [symbol: string]: string } } = {
  [ChainId.MAINNET]: {
    WETH: WRAPPED_NATIVE_ADDRESS[ChainId.MAINNET],
    // Stable Coins
  ...
  [ChainId.ROPSTEN]: {
    WETH: WRAPPED_NATIVE_ADDRESS[ChainId.ROPSTEN],
  ...
  [ChainId.KOVAN]: {},
  [ChainId.BSC]: {
    WBNB: WRAPPED_NATIVE_ADDRESS[ChainId.BSC],
  ...
  [ChainId.MATIC]: {
    ...
    WMATIC: WRAPPED_NATIVE_ADDRESS[ChainId.MATIC],
